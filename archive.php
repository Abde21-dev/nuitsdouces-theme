...
<!-- Hero catégorie -->
<div class="nd-archive__hero">
    <div class="nd-container">
        <span class="nd-label" style="display:block;text-align:center;margin-bottom:.75rem;">
            <?php
        ...
        <h1 class="nd-archive__title"><?php single_term_title(); ?></h1>
        <?php if ( term_description() ) : ?>
            <p class="nd-archive__desc"><?php echo term_description(); ?></p>
        <?php endif; ?>
    </div>
</div>
